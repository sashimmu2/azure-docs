...
```powershell
PS C:\> Start-AzBasicLoadBalancerUpgrade -StandardLoadBalancerName <newStandardLBName> -validateCompletedMigration -basicLoadBalancerStatePath C:\RecoveryBackups\State_mybasiclb_rg-basiclbrg_20220912T1740032148.json
```
